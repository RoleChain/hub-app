  ...
  return (
    ...
    >
      <nav className="flex flex-col items-center pt-8">
        ...
        <div className="flex w-full flex-col gap-1 px-4">
          ...
          {isAgentsOpen && agents.map((agent) => (
           ...
           <button className="w-full rounded-[12px] bg-[#F700F7] px-4 py-3 font-medium text-white hover:opacity-90 transition-opacity">Get Started</button>
      ...
      {user ? (
        ...
        // Container for the sign-up button and authentication dialog
        <div className="flex w-full cursor-pointer items-center gap-2 px-8 text-muted-foreground hover:text-foreground">
          {/* Sign-up button with gradient background and hover effect */}
          <button
            className="w-full rounded-[12px] bg-gradient-to-b from-[#FF6600] via-[#F700F7] to-[#0078F6]  px-4 py-2.5 font-semibold text-white hover:opacity-90 transition-opacity"
...
//     >
//       <nav className="flex flex-col items-center pt-8">
//         <Link className="ml-2 mr-auto w-fit px-4" href="/">
//           <Image src={Logo || "/placeholder.svg"} alt="Site Logo" className="mt-12 md:mt-0" />
//         </Link>
//         {/* separator #1 */}
//         <div className="mx-auto my-6 h-[1px] w-[80%] border-t-[0.01em] border-[#444]" />
//         <div className="flex w-full flex-col gap-1 px-4">
...
//               onClick={() => setIsAgentsOpen(!isAgentsOpen)}
//               className={cn(
//                 "flex w-full items-center justify-between gap-2 rounded-lg px-3 py-2 text-[#667085] transition-colors hover:bg-gray-50",
//                 isAgentsOpen ? "bg-gray-50" : null,
//               )}
//             >
//               <div className="flex items-center gap-2">
//                 <Bot size={20} className="text-[#667085]" />
...
//             <button
//               onClick={() => setIsAuthDialogOpen(true)}
//               className="w-full rounded-[12px] bg-[#F700F7] px-4 py-3 font-medium text-white hover:opacity-90 transition-opacity"
//             >
//               Get Started
//             </button>
//           {/* )} */}
//            <div className="flex items-center gap-2">
//               <Image src={ChatIcon || "/placeholder.svg"} alt="Chat" width={20} height={20} />
//               <span className="inline-block">All Agents</span>
//             </div>
...
//             href="/chats"
//             className={cn(
//               "flex w-full items-center gap-2 rounded-lg px-3 py-2 text-[#667085] transition-colors hover:bg-gray-50",
//               segments.includes("chats") ? "bg-gray-50" : null,
//             )}
//           >
//             <HistoryIcon size={20} stroke="#667085" />
...
//             <div className="flex items-center gap-2">
//               <Image src={ChatIcon || "/placeholder.svg"} alt="Chat" width={20} height={20} />
//               <span className="inline-block">All GPT's</span>
//             </div>
//             <ChevronDown className={cn("transition-transform", isGPTOpen && "rotate-180")} size={20} stroke="#667085" />
//           </button>
//           {/* )} */}
//           {isGPTOpen && (
//             <>
...
//                 href="/gpt/research-assistant"
//                 className={cn(
//                   "flex w-full items-center gap-2 rounded-lg px-3 py-2 pl-8 text-sm text-[#667085] transition-colors hover:bg-gray-50",
//                   segments.includes("gpt") && segments.includes("research-assistant") ? "bg-gray-50" : null,
//                 )}
//               >
//                 Research Assistant
//               </Link>
...
//       )} */}
//       {user ? (
//         <div className="mb-2 mt-auto w-full px-4">
//           <span className="text-sm text-[#667085]">My Stats</span>
//           <div className="mt-2 flex gap-2">
//             <div className="flex-1 rounded-lg border bg-white p-3">
//               <span className="text-xs text-[#667085]">Contributions</span>
//               <div className="mt-1 text-xl font-medium">20</div>
//             </div>
//             <div className="flex-1 rounded-lg border bg-white p-3">
//               <span className="text-xs text-[#667085]">$ROAI Earned</span>
//               <div className="mt-1 flex items-center gap-1">
//                 <ImgBlurTemp width={16} height={16} />
//                 <span className="text-xl font-medium">4200</span>
//               </div>
//             </div>
//           </div>
//           <div className="mt-4 rounded-lg bg-[#F5F8FF] p-4">
//             <div className="text-sm">Invite & Earn a Rolecieco!</div>
//             <div className="mt-1 text-xs text-[#667085]">Share friends and unlock exclusive rewards! 🚀</div>
//             <button
//               onClick={() => {
//                 copyToClip("rolecieco")
//                 toast({
...
//                 })
//               }}
//               className="mt-2 w-full rounded-lg bg-gradient-to-r from-[#FF6600] via-[#F700F7] to-[#0078F6] py-2 text-center text-sm font-medium text-white hover:opacity-90 transition-opacity"
//             >
//               ROLECIECO
//             </button>
//           </div>
...
//                     alt="user img"
//                   />
//                   <Avatar.Fallback className="flex content-center items-center bg-white text-sm" delayMs={600}>
//                     CT
//                   </Avatar.Fallback>
//                 </Avatar.Root>
//               </div>
//               <div className="flex flex-col justify-between truncate">
//                 <span className="inline-block text-sm font-semibold text-[#344054]">{user.first_name}</span>
//                 <span className="inline-block w-full truncate text-sm text-[#444]">{user.email}</span>
//               </div>
//             </div>
